...
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-14 max-w-3/4 justify-self-center">
...
//             >
//               <div className="flex items-center gap-4 px-5 py-4 bg-gray-300/50">
//                 <img
...
//                         key={i}
//                         src={
//                           i < Math.floor(calculateRating(course)) ? assets.star : assets.star_blank
//                         }
//                         alt="star"
//                       />
//                     )),
...
const TestimonialsSection = () => {
  return (
    <div className="pb-14 px-8 md:px-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-14 max-w-[75%] mx-auto">
        {dummyTestimonial.map((testimonial, index) => (
          <div
            key={index}
            className="text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden"
